...
class MultiSelectAdapter extends ListAdapter<MultiSelectable, MultiSelectViewHolder> {
    ...
    private MultiSelectViewHolder getViewHolder(@NonNull Context context) {
        ...
        Resources.Theme theme = context.getTheme();
        int[] attrs;
        attrs = new int[]{ R.attr.listPreferredItemHeight, R.attr.listPreferredItemPaddingLeft, R.attr.listPreferredItemPaddingRight,
                R.attr.selectableItemBackground, R.attr.textAppearanceListItem, R.attr.colorAccent };
